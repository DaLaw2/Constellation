<template>
  <Teleport to="body">
    <div v-if="show" class="image-lightbox" @click="handleBackdropClick">
...
const show = computed(() => fileExplorerStore.showLightbox)
const selectedImage = computed(() => fileExplorerStore.selectedImage)
const canNavigatePrev = computed(() => fileExplorerStore.canNavigatePrevImage)
const canNavigateNext = computed(() => fileExplorerStore.canNavigateNextImage)
...
function close() {
  fileExplorerStore.closeLightbox()
}

function navigatePrev() {
  fileExplorerStore.navigatePrevImage()
}

function navigateNext() {
  fileExplorerStore.navigateNextImage()
}
